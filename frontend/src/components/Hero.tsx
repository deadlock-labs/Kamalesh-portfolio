...
export default function Hero({ name, title, bio, linkedin, github, medium, email }: HeroProps) {
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center grid-bg overflow-hidden">
      ...
      <div className="absolute top-1/4 -left-32 w-96 h-96 bg-[#00d4ff]/5 rounded-full blur-[120px] animate-float" />
      <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-[#7c3aed]/5 rounded-full blur-[120px] animate-float" style={{ animationDelay: '3s' }} />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          ...
          <span className="text-sm font-mono text-white/60">
            ~/portfolio<span className="cursor-blink text-[#00d4ff]">_</span>
          </span>
        </motion.div>
        ...
        >
          {[
            ...
            <a
              ...
              className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-[#00d4ff] hover:border-[#00d4ff]/30 hover:bg-[#00d4ff]/5 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,212,255,0.15)]"
              aria-label={label}
            >
              <Icon size={20} />
            </a>
        ...
        >
          <a
            href="#projects"
            className="px-8 py-3 rounded-xl bg-gradient-to-r from-[#00d4ff] to-[#7c3aed] text-white font-medium hover:shadow-[0_0_30px_rgba(0,212,255,0.3)] transition-all duration-300 hover:scale-105"
          >
            View My Work
          </a>
          <a
